 ...
 *
 *  среднее время поиска: log(n)
 *  худшее время поиска: n
 *  потому что возможна ситуация когда элементы идут друг за другом 1,2,3,4... и дерево приобретает следующий вид:
 *  1
 *   \
 *    2
 *     \
 ...
 *       \
 *        4
 * таже самая сложность верна для добавления и удаления узлов
 */
